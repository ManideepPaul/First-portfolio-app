...
function Navbar() {
  ...
  return (
    <nav className={`${!state ? "flex flex-col space-y-5 items-center" : "" }flex items-center justify-between mx-10 pt-3 pb-3 sticky top-0 bg-body z-10`}>
        <p className={` font-baloo2 text-text font-bold text-2xl p-2 mx-5`}>Manideep.paul</p>
      <div className={`${state ? "hidden" : "flex flex-col space-y-5 items-center"} md:flex text-text mx-5 text-lg font-semibold md:space-x-16`}>
          <p className=" pt-2 hover:text-text-secondary">Home</p>
          <p className=" pt-2 hover:text-text-secondary">Projects</p>
          <p className="hover:bg-backcolor hover:text-text-secondary border-2 font-bold border-backcolor px-6 py-2 rounded-lg">Contact Me</p>
      </div>
