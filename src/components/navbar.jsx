...
function Navbar() {
  ...
  return (
    <nav className={`${!state ? "flex flex-col space-y-5 items-center" : "" }flex items-center lg:self-center justify-between px-3 lg:px-10 lg:w-full pt-3 pb-3 sticky top-0 bg-body z-10`}>
